<div class="form-group {{ $errors->has('created_at') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="created_at" type="datetime-local" id="created_at" value="{{ isset($formtransaction->created_at) ? $formtransaction->created_at : ''}}" >
    {!! $errors->first('created_at', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('updated_at') ? 'has-error' : ''}}">
    <label for="updated_at" class="control-label">{{ 'Updated At' }}</label>
    <input class="form-control" name="updated_at" type="datetime-local" id="updated_at" value="{{ isset($formtransaction->updated_at) ? $formtransaction->updated_at : ''}}" >
...
<div class="form-group {{ $errors->has('productid') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="productid" type="number" id="productid" value="{{ isset($formtransaction->productid) ? $formtransaction->productid : ''}}" >
