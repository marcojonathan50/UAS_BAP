                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Created At </th><td> {{ $formtransaction_detail->created_at }} </td></tr><tr><th> Updated At </th><td> {{ $formtransaction_detail->updated_at }} </td></tr><tr><th> Productid </th><td> {{ $formtransaction_detail->Productid }} </td></tr>
                                </tbody>
                            </table>
                        </div>
